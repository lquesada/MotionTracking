...
void drawScreen(outputscreen *a,point *center,rectangle *area,matrix *b,matrix *c,matrix *d,matrix *e,int timeStarted,int timeCaptured,int timeProcessed,int timeScreen) {
...
int main(int argc,char *argv[]) {
  ...
  startScreen(&sc,"Depth Perception Experiment",1056,600);
